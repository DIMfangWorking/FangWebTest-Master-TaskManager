...
public class EnbIDOperationServiceImpl extends AtomOperation implements AtomOperationService {
	...
	public void atomAction(Object... objects) {
		...
		atom.addAttribute("value", String.valueOf(subResource.getEnbID()));
